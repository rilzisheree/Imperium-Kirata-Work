...
local SCRIPT_DEFS = {
        ...
        Korean = {
                ...
                chars = {
                        ...
                        "셰","녜","례","몌","볘","예","졔","쳬","켸","혜",
                        -- Closed syllables (C+V+C) — add weight to common finals
        ...
        Japanese = {
                chars = {
                        ...
                        "ぱ","ぴ","ぷ","ぺ","ぽ",
                        -- Common digraphs — treated as single pool entries
                        "きゃ","きゅ","きょ",
                        "しゃ","しゅ","しょ",
                        "ちゃ","ちゅ","ちょ",
                        "にゃ","にゅ","にょ",
                        ...
                        "びゃ","びゅ","びょ",
                        "ぴゃ","ぴゅ","ぴょ",
                        -- Extra weight on vowel-heavy sounds for pronounceability
                        "あ","い","う","え","お","あ","い","う","え","お",
                },
                ratio = 0.6,
        },
        ...
        Hebrew = {
                chars = {
                        ...
                        -- Final forms
                        "ך","ם","ן","ף","ץ",
                        -- Extra weight on high-frequency Hebrew letters
                        "א","ו","י","ל","מ","נ","ר","ש","ת","ה",
                        "ו","י","מ","נ","ר","ה",
                },
                ratio = 1.0,
